/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.staging.jsonc` (hash: bbdc5d759b80b76928c11b4ef98ea895)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	PORTAL_FILES: R2Bucket;
	ASSETS: Fetcher;
	PUBLIC_ORIGIN: "https://portal-test.bitwise-security.nl";
	DEPLOYMENT_ENVIRONMENT: "staging";
	EMAIL_FROM: "Bitwise Secure Portal <portal@bitwise-security.nl>";
	PORTAL_CONTAINER: DurableObjectNamespace<import("./src/index").PortalContainer>;
	AUTH_RATE_LIMITER: DurableObjectNamespace<import("./src/index").AuthRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PortalContainer" | "AuthRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "DEPLOYMENT_ENVIRONMENT" | "EMAIL_FROM">> {}
}
